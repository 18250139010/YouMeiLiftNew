...
@interface DDGBannerScrollView () <UICollectionViewDataSource, UICollectionViewDelegate,UIGestureRecognizerDelegate>


@property (nonatomic, weak) YXCollectionView *mainView; // 显示图片的collectionView
...
- (void)setupMainView {
    ...
    YXCollectionView *mainView = [[YXCollectionView alloc] initWithFrame:self.bounds collectionViewLayout:flowLayout];
...
- (void)setImageURLStringsGroup:(NSArray *)imageURLStringsGroup {
    if (imageURLStringsGroup.count < 2) {
        _infiniteLoop = NO;
    }
...
- (void)scrollToIndex:(int)targetIndex {
    ...
    if ([self.locationStr isEqualToString:@"home"]) {
